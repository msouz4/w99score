            ...
            container.innerHTML = favs.map(fav => `
                <div class="fav-card">
                    <div class="fav-header">
                        <img class="fav-logo" src="api.php?action=get_image&type=tournament&id=${fav.tournament_id}&v=2" alt="${fav.name}" onerror="this.style.opacity=0.3">
                        <div>
                    ...
                    <div class="db-match-card ${isIncomplete ? 'incomplete' : ''}">
                        ...
                        <div class="teams-container">
                            <div class="team home">
                                ...
                                <img class="team-flag" src="api.php?action=get_image&type=team&id=${m.home_team_id}&v=2" alt="" onerror="this.style.opacity=0.3">
                            </div>
                            <div class="score-box">
                                ${m.home_score_ft ?? '-'} : ${m.away_score_ft ?? '-'}
                            </div>
                            <div class="team away">
                                <img class="team-flag" src="api.php?action=get_image&type=team&id=${m.away_team_id}&v=2" alt="" onerror="this.style.opacity=0.3">
